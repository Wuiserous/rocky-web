export const COMPOSIO_CALLBACK_URL = "https://getrockyapp.com/oauth/composio/callback";

export const PROVIDER_TOOLKITS = {
  gmail: "gmail",
...
export function isSupportedProvider(provider) {
  return Object.hasOwn(PROVIDER_TOOLKITS, provider);
}

export function getToolkitForProvider(provider) {
